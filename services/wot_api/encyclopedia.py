...
class EncyclopediaVehicles(RequestToAPI):
    def __init__(self, fields="", language="", limit=0, nation="", page_no=0, tank_id="", tier="", type=""):
    ...
    def get_response(self):
        return self.request_to_api(url="https://api.worldoftanks.ru/wot/encyclopedia/vehicles/")